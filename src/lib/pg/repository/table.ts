...
export class Table<TG extends TableGeneric = TableGeneric> {
	...
	compareQuery = {
		 ...
		 */
		createMany: <T extends Extract<keyof TG["CoreFields"], string>[] = Extract<keyof TG["CoreFields"], string>[]>(
		...
		createOne: (
			recordParams: Types.TConditionalRawParamsType<TG["CreateFields"], TG["CoreFields"]>,
			saveOptions?: { returningFields?: Extract<keyof TG["CoreFields"], string>[]; },
		 ...
		 */
		updateByParams: <T extends Extract<keyof TG["CoreFields"], string>[] = Extract<keyof TG["CoreFields"], string>[]>(
			queryConditions: {
				params: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>;
				paramsOr?: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>[];
				returningFields?: T;
	 ...
	 */
	async getArrByParams<T extends keyof TG["CoreFields"]>(this: Table<TG>, options: {
		params: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>;
		paramsOr?: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>[];
		selected?: [T, ...T[]];
		pagination?: SharedTypes.TPagination;
	 ...
	 * @returns A promise that resolves to an array of records with the selected fields.
	 */
	async streamArrByParams<T extends keyof TG["CoreFields"]>(this: Table<TG>, options: {
		params: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>;
		paramsOr?: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>[];
		selected?: [T, ...T[]];
		pagination?: SharedTypes.TPagination;
	 ...
	 */
	async updateByParams<T extends Extract<keyof TG["CoreFields"], string>[] = Extract<keyof TG["CoreFields"], string>[]>(
		queryConditions: {
			params: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>;
			paramsOr?: Types.TSearchParams<Types.TConditionalDomainFieldsType<TG["SearchFields"], TG["CoreFields"]>>[];
			returningFields?: T;
